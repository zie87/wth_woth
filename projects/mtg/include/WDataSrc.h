...
public:
    ...
    // Wrapped functions
    JQuadPtr getImage(int offset = 0) { return active->getImage(offset); }

    JQuadPtr getThumb(int offset = 0) { return active->getThumb(offset); }
    ...
    void bakeFilters() { active->bakeFilters(); }
