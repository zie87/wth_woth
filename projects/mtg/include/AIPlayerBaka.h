...
protected:
    ...
    virtual bool payTheManaCost(ManaCost* cost, MTGCardInstance* card = NULL,
...
public:
    ...
    AIPlayerBaka(GameObserver* observer, string deckFile, string deckfileSmall, string avatarFile,
                 MTGDeck* deck = NULL);
