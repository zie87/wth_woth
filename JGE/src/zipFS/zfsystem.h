...
public:
    ...
    public:
        ...
        limited_file_info(size_t Offset, size_t Size) : m_Offset(Offset), m_Size(Size) {}
...
inline izfstream::izfstream(const char* FilePath, filesystem* pFS) : m_pFS(pFS) { open(FilePath); }
...
inline bool izfstream::isBeingUsed() const { return m_Used; }

inline const std::string& izfstream::FilePath() const { return m_FilePath; }

inline const std::string& izfstream::FullFilePath() const { return m_FullFilePath; }
...
inline void filesystem::MakeDefault() { izfstream::pDefaultFS = this; }

inline std::string filesystem::getCurrentZipName() { return CurrentZipName; }

inline filesystem* filesystem::getCurrentFS() { return pCurrentFS; }
