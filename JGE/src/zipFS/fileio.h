...
template <class T>
std::istream& readvar(std::istream& File, T& Var, const std::streamsize NbBytes);
template <class T>
std::ostream& writevar(std::ostream& File, const T& Var, const std::streamsize NbBytes);
...
inline search_iterator::operator bool() const { return m_Valid; }

inline search_iterator& search_iterator::operator++() { return next(); }
...
inline bool search_iterator::end() const { return false; }
