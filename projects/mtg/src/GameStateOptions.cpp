...
void GameStateOptions::Start() {
    ...
    if (options[Options::DIFFICULTY_MODE_UNLOCKED].number) {
        ...
        optionsList->Add(
            NEW WDecoEnum(NEW OptionInteger(Options::ECON_DIFFICULTY, "Economic Difficuly", Constants::ECON_EASY)));
    }
    ...
    auto* oFirstPlayer = NEW WDecoEnum(NEW OptionInteger(Options::FIRSTPLAYER, "First Turn Player", Constants::WHO_R,
                                                         1, Constants::WHO_P, "", Constants::WHO_P));
