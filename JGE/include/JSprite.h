...
public:
    ...
    ///
    //////////////////////////////////////////////////////////////////////////
    JSprite(JTexture* tex = NULL, float x = 0.0f, float y = 0.0f, float width = 0.0f, float height = 0.0f,
            bool flipped = false);
...
public:
    ...
    // bool CheckCollision(JSprite* sprite);							// check collision against the provided
    // list void SetCollisionListener(JCollisionListener *listener);
