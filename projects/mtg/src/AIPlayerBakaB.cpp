...
int AIPlayerBakaB::getEfficiency(OrderedAIAction* action) { return AIPlayerBaka::getEfficiency(action); }

ManaCost* AIPlayerBakaB::getPotentialMana(MTGCardInstance* target) { return AIPlayerBaka::getPotentialMana(target); }

int AIPlayerBakaB::CanHandleCost(ManaCost* cost) { return AIPlayerBaka::CanHandleCost(cost); }

int AIPlayerBakaB::canHandleCost(MTGAbility* ability) { return AIPlayerBaka::canHandleCost(ability); }
...
int AIPlayerBakaB::selectHintAbility() { return AIPlayerBaka::selectHintAbility(); }

int AIPlayerBakaB::selectAbility() { return AIPlayerBaka::selectAbility(); }

int AIPlayerBakaB::interruptIfICan() { return AIPlayerBaka::interruptIfICan(); }
...
int AIPlayerBakaB::selectMenuOption() { return AIPlayerBaka::selectMenuOption(); }

MTGCardInstance* AIPlayerBakaB::FindCardToPlay(ManaCost* pMana, const char* type) {
    return AIPlayerBaka::FindCardToPlay(pMana, type);
}

void AIPlayerBakaB::initTimer() { return AIPlayerBaka::initTimer(); }

int AIPlayerBakaB::computeActions() { return AIPlayerBaka::computeActions(); };
...
int AIPlayerBakaB::chooseAttackers() { return AIPlayerBaka::chooseAttackers(); }
...
int AIPlayerBakaB::chooseBlockers() { return AIPlayerBaka::chooseBlockers(); }

int AIPlayerBakaB::orderBlockers() { return AIPlayerBaka::orderBlockers(); }

int AIPlayerBakaB::affectCombatDamages(CombatStep step) { return AIPlayerBaka::affectCombatDamages(step); }

// TODO: Deprecate combatDamages
int AIPlayerBakaB::combatDamages() { return AIPlayerBaka::combatDamages(); }

//
// General
//

AIStats* AIPlayerBakaB::getStats() { return AIPlayerBaka::getStats(); }

void AIPlayerBakaB::Render() { return AIPlayerBaka::Render(); }

int AIPlayerBakaB::receiveEvent(WEvent* event) { return AIPlayerBaka::receiveEvent(event); }
...
int AIPlayerBakaB::Act(float dt) { return AIPlayerBaka::Act(dt); };
