...
static u32 gPSPKeyMasks[] = {
    PSP_CTRL_SELECT,   PSP_CTRL_START,    PSP_CTRL_UP,       PSP_CTRL_RIGHT,  PSP_CTRL_DOWN,  PSP_CTRL_LEFT,
    PSP_CTRL_LTRIGGER, PSP_CTRL_RTRIGGER, PSP_CTRL_TRIANGLE, PSP_CTRL_CIRCLE, PSP_CTRL_CROSS, PSP_CTRL_SQUARE,
    PSP_CTRL_HOME,     PSP_CTRL_HOLD,     PSP_CTRL_NOTE,     PSP_CTRL_CIRCLE, PSP_CTRL_START,
};
...
static const int gGlutKeyCodes[] = {0,
                                    0,
                                    GLUT_KEY_UP,
                                    GLUT_KEY_RIGHT,
                                    GLUT_KEY_DOWN,
...
static const unsigned char gNonGlutKeyCodes[] = {KEY_BACKSPACE, KEY_RETURN, 0, 0, 0,         0,         0, 0, 0, 0, 0,
                                                 KEY_DELETE,    0,          0, 0, KEY_SPACE, KEY_ESCAPE};
...
{
    DestroyGame();
    if (glWindowID) glutDestroyWindow(glWindowID);
    glWindowID = 0;
}
...
void JGEControl() { gOldButtons = gButtons; }
...
bool JGEGetButtonState(u32 button) { return gButtons & button; }

bool JGEGetButtonClick(u32 button) { return (gButtons & button) && (!(gOldButtons & button)); }
...
void idleCallBack(void) { glutPostRedisplay(); }
