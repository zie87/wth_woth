#ifndef WOTH_WGE_UTILS_DEFER_HPP
#define WOTH_WGE_UTILS_DEFER_HPP
...
#define wge_defer \
    [[maybe_unused]] auto WGE_TOKEN_PASTE2(__deferred_lambda_call, __COUNTER__) = wge::detail::deferrer{} << [&]

#endif  // WOTH_WGE_UTILS_DEFER_HPP
