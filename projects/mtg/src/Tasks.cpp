...
string TaskPacifism::createDesc() {
    ...
    case 0:
        sprintf(buffer,
                _("Let your opponent live with at least %i life and cards in library, but defeat him.").c_str(),
                lifeSlashCardMin);
        break;
    case 1:
...
/* ------------ Task template ------------
 ...
 // TODO: Implement
 return (!observer->players[0]->isAI()) && (observer->players[1]->isAI()) && (observer->gameOver != _p1) // Human
 player wins
 }
