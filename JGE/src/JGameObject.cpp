...
void JGameObject::EnableAlpha(bool flag, float delta) {
    mDoAlpha = flag;
    mAlphaDelta = delta;
}
void JGameObject::EnableScaling(bool flag, float delta) {
    mDoScaling = flag;
    mScaleDelta = delta;
}
void JGameObject::EnableRotation(bool flag, float delta) {
    mDoRotation = flag;
...
JGameObject* JGameObject::GetCollisionTarget() { return mCollisionTarget; }
